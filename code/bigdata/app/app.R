...
css <-"
  large.selectize-input{ line-width = '400px'}
  large.selectize-dropdown{ line-width = '4000px'}
"

ui <- navbarPage("Chasing Your Dream School",
                 theme=shinytheme("united"),
                 
                 
                 tabPanel("Student Profile",
                          
                          helpText("©Xiuyue Wang & Chee Kit Tang & Bing Han"),
                          ...
                          sidebarLayout(
                            sidebarPanel(
                              ...
                              sliderInput("p0", 
                                          label = "Number of recommended universities:",
                              ...
                              br(),
                              fluidPage(
                                selectInput("p1", label = h3("Gender"), 
                              ...
                              fluidPage(
                                selectInput("p2", label = h3("Ethnic"), 
                                            choices = list("White" = "white", "Black" = "black", "Hispanic" = "hispanic", "Asian" = "asian","American Indian/Alaska Native" = "american_alaska", "Native Hawaiian/Pacific Islander" = "hawaiian_pacific", "Two or more races" = "two_more_races", "Non-resident aliens" = "non_resident", "Race unknown" = "race_unknown"), 
                                            selected = 1),
                              ...
                              fluidPage(
                                fluidRow(
                                  column(4,
                                         selectInput("p3", label = h5("Household"), 
                                                     choices = list("Dependent" = "TRUE", "Independent" = "FALSE"), 
                                                     selected = 1,
                                                     selectize = TRUE)),
                                  column(4,
                                         selectInput("p4", label = h5("Household Income"), 
                                                     choices = list("Less than $30,000" = "le30K", "Between $30,001 & $110,000" = "gt30Kle110K", "More than $110,001" = "gt110K"), 
                                                     selected = 1)),
                                  column(3,
                                         
                                         selectInput("p5", label = h5("Importance of Tuition"), 
                                                     choices = list("Low" = "L","Medium" = "M", "High" = "H"), 
                                                     selected = 1))
                              ...
                              fluidPage(
                                fluidRow(
                                  column(5,
                                         selectInput("p6", label = h5("SAT"), 
                                                     choices = list("Lower than 800" = "le800", "Between 801 & 1000" = "gt800le1000", "Between 1001 & 1200" = "gt1000le1200", "Between 1201 & 1400" = "gt1200le1400", "Higher than 1401" = "gt1400"), 
                                                     selected = 1)),
                                  column(5,offset = 1,
                                         selectInput("p7", label = h5("Importance of SAT"), 
                                                     choices = list("Low" = "L","Medium" = "M", "High" = "H"), 
                                                     selected = 1))
                              ...
                              fluidPage(
                                fluidRow(
                                  column(5,
                                         selectInput("p8", label = h5("Locale"), 
                                                     choices = list("Rural" = "Rural", "TownRemote" = "TownRemote", "TownDistant" = "TownDistant", "SmallSuburb" = "SuburbSmallMid", "LargeSuburb" = "SuburbLarge", "SmallCity" = "CitySmall", "MidCity" = "CityMidsize", "LargeCity" = "CityLarge"), 
                                                     selected = 1)),
                                  column(5,offset = 1,
                                         selectInput("p9", label = h5("Importance of Locale"), 
                                                     choices = list("Low" = "L","Medium" = "M", "High" = "H"), 
                                                     selected = 1))
                              ...
                              fluidPage(
                                fluidRow(
                                  column(5,
                                         selectInput("p10", label = h5("Region"), 
                                                     choices = list("FarWest" = "FarWest", "GreatLakes" = "GreatLakes", "MidEast" = "MidEast", "NewEngland" = "NewEngland", "Plains" = "Plains", "RockyMountains" = "RockyMountains", "SouthEast" = "Southeast", "SouthWest" = "Southwest"), 
                                                     selected = 1)),
                                  column(5,offset = 1,
                                         selectInput("p11", label = h5("Importance of Region"), 
                                                     choices = list("Low" = "L","Medium" = "M", "High" = "H"), 
                                                     selected = 1)))
             ...
             mainPanel(
               tabsetPanel(
                 tabPanel("Recommendations", plotOutput("plot1")), 
                 tabPanel("Earnings", plotOutput("plot2")), 
...
server <- (function(input, output){
    output$text2 <- renderText("Here are schools recommened for you:")
    output$plot1 <- renderPlot({
      width = "auto"
      height = "auto"
      
      a = profile(input$p1,input$p2,input$p3,input$p4,input$p5,input$p6,input$p7,input$p8,input$p9,input$p10,input$p11)
      chasingdreamschool(a,input$p0[2])
    })
    output$plot2 <- renderPlot({
      ...
      a = profile(input$p1,input$p2,input$p3,input$p4,input$p5,input$p6,input$p7,input$p8,input$p9,input$p10,input$p11)
      chasingdreamschoolEarning(a,input$p0[2])
    ...
    output$plot3 <- renderLeaflet({
      ...
      a = profile(input$p1,input$p2,input$p3,input$p4,input$p5,input$p6,input$p7,input$p8,input$p9,input$p10,input$p11)
      chasingdreamschoolMap(a,input$p0[2])
